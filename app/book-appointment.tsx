...
export default function BookAppointment({vehicleId,vehicleName}:{vehicleId:string;vehicleName:string}){
 ...
 useEffect(()=>{if(open&&receipt)confirmation.current?.focus({preventScroll:true})},[open,receipt]);
