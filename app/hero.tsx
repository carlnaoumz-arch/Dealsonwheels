...
export default function Hero(){
  ...
  return <section ref={ref} className={`cinema brand-cinema ${reduced?'reduced':''}`} aria-label="Discover Deals On Wheels"><div className="stage">
    <div className="distant-studio-lamp" aria-hidden="true"><span className="lamp-spill"/><span className="lamp-cable"/><span className="lamp-shade"/><span className="lamp-source"/></div>
